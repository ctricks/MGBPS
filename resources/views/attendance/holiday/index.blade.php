                ...
                <tbody>
                    @foreach ($data as $hDet)
                        <tr>
                            ...
                            <td>{{ $hDet->UpdatedDate }}</td>
                            <td>{{ $hDet->UpdatedBy }}</td>
                            {{-- <td><div style="display:inline-block;margin-right:5px;"><a href="{{ route('attendance.holiday.edit', encrypt($hDet->id)) }}"
                                    class="btn btn-sm btn-primary">Edit</a></div>
                                <div style="display:inline-block;margin-right:5px;"> --}}
                            <td>
                                <div>
                                <form action="{{ route('attendance.holiday.destroy', encrypt($hDet->id)) }}" method="POST"
