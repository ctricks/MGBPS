    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?php echo e(route('admin.overtimetype.create')); ?>" class="btn btn-sm btn-info">New</a>
            </div>
        </div>
                ...
                <tbody>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ottDet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('admin.overtimetype.edit', encrypt($ottDet->id))); ?>"
                                    class="btn btn-sm btn-primary">Edit</a></td>
                            <td>
                                <form action="<?php echo e(route('admin.overtimetype.destroy', encrypt($ottDet->id))); ?>" method="POST"
...
<?php endif; ?>
 <script>
  ...
  </script><?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/overtimetype/index.blade.php ENDPATH**/ ?>