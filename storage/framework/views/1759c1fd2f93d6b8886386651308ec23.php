...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Create Loan Type'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Create Loan Type</h3>
            <div class="card-tools"><a href="<?php echo e(route('admin.loantype.index')); ?>" class="btn btn-sm btn-dark">Back</a></div>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.loantype.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="empnumber" class="form-label">Loan Type Name:*</label>
                            <input type="text" class="form-control" id="loantype" name="loantype"
                                placeholder="Enter Loan Type" required >
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/loantype/create.blade.php ENDPATH**/ ?>