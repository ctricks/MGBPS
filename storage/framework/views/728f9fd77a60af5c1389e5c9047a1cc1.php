...
<div class="card-body">
            Filter:
            <form action="<?php echo e(route('deductions.loans.list')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-2">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ltDet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><div style="display: flex; gap: 10px;">
                                ...
                                <form action="<?php echo e(route('deductions.loan.decline', encrypt($ltDet->id))); ?>" method="POST"
                                    onsubmit="return confirm('Are sure want to Decline?')">
                                    <?php echo method_field('PATCH'); ?>
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-sm btn-warning">Decline</button>
                                </form>
                                <form action="<?php echo e(route('deductions.loans.destroy', encrypt($ltDet->id))); ?>" method="POST"
...
<?php endif; ?>
 <?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/deduction/loans/index.blade.php ENDPATH**/ ?>