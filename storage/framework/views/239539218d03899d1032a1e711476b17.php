...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Edit Civil Status'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Civil Status</h3>
            <div class="card-tools"><a href="<?php echo e(route('admin.civilstatus.index')); ?>" class="btn btn-sm btn-dark">Back</a></div>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.civilstatus.update',$civilstatus)); ?>" method="POST">
                <?php echo method_field('PUT'); ?>
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" value="<?php echo e($civilstatus->id); ?>">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="civilstatus" class="form-label">Civil Status:*</label>
                            <input type="text" class="form-control" name="civilstatus" required
                                value="<?php echo e($civilstatus->civilstatus); ?>">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/civilstatus/edit.blade.php ENDPATH**/ ?>