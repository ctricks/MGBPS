...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title','Loan Type'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Loan Type Table</h3>
            <div class="card-tools">
                <a href="<?php echo e(route('admin.loantype.create')); ?>" class="btn btn-sm btn-info">New</a>
            </div>
        </div>
...
unset($__sessionArgs); ?>
        ...
        <div class="card-body">
            <table class="table table-striped" id="loantypeTable">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Loan Type</th>
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/loantype/index.blade.php ENDPATH**/ ?>