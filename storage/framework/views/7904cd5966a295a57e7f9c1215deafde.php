...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Create Gender'); ?>
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.gender.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-6">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/gender/create.blade.php ENDPATH**/ ?>