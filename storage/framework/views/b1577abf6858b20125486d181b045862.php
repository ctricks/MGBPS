...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Create Overtime Type'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Create Overtime Type</h3>
            <div class="card-tools"><a href="<?php echo e(route('admin.overtimetype.index')); ?>" class="btn btn-sm btn-dark">Back</a>
            </div>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.overtimetype.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-2">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/overtimetype/create.blade.php ENDPATH**/ ?>