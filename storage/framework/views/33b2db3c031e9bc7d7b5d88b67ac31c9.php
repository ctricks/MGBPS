...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Create Leave'); ?>
    <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <select name="leavetype" id="leavetype" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $LeaveType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lt->id); ?>"><?php echo e($lt->LeaveType); ?> ( <?php echo e($lt->Description); ?> )</option>                                
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/attendance/holiday/create.blade.php ENDPATH**/ ?>