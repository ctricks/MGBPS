...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Edit Overtime Type'); ?>
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Edit Overtime Type</h3>
                        <div class="card-tools">
                            <a href="<?php echo e(route('attendance.overtimetype.index')); ?>" class="btn btn-info btn-sm">Back</a>
                        </div>
                    </div>
                    <form class="needs-validation" novalidate action="<?php echo e(route('attendance.overtimetype.update', $data)); ?>"
                        method="POST">
                        ...
                        <div class="card-body">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="lblWorkSchedule" class="form-label">Overtime Type Name:*</label>
                                    <input type="text" class="form-control" id="overtimetype" name="overtimetype"
                                        placeholder="Enter Leave Type Name" value="<?php echo e($data->OvertimeType); ?>" required>
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/overtimetype/edit.blade.php ENDPATH**/ ?>