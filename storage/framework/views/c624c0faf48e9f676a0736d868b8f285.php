...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Edit Loan Type'); ?>
                ...
                <div class="card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="<?php echo e(route('admin.loantype.index')); ?>" class="btn btn-info btn-sm">Back</a>
                        </div>
                    </div>
                    <form class="needs-validation" novalidate action="<?php echo e(route('admin.loantype.update', $data)); ?>"
                        method="POST">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="LoanType" name="LoanType"
                                        placeholder="Enter Leave Type Name" value="<?php echo e($data->LoanType); ?>" required>
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/loantype/edit.blade.php ENDPATH**/ ?>