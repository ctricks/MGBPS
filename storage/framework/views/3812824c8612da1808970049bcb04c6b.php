...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Edit Gender'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Gender</h3>
            <div class="card-tools"><a href="<?php echo e(route('admin.gender.index')); ?>" class="btn btn-sm btn-dark">Back</a></div>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.gender.update',$gender)); ?>" method="POST">
                <?php echo method_field('PUT'); ?>
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" value="<?php echo e($gender->id); ?>">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="gender" class="form-label">Gender:*</label>
                            <input type="text" class="form-control" name="gender" required
                                value="<?php echo e($gender->gender); ?>">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/gender/edit.blade.php ENDPATH**/ ?>