...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.civilstatus.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-6">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/civilstatus/create.blade.php ENDPATH**/ ?>