                ...
                <div class="card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="<?php echo e(route('admin.category.index')); ?>" class="btn btn-info btn-sm">Back</a>
                        </div>
                    </div>
                    <form class="needs-validation" novalidate action="<?php echo e(route('admin.category.update',$data)); ?>" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Enter category name" required value="<?php echo e($data->id); ?>">
                            </div>
