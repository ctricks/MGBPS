...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Create Loan'); ?>
    <div class="card">
                            ...
                            <select name="LoanType" id="LoanType" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $loanType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lt->LoanType); ?>"
                                        <?php echo e($lt->LoanType == old('LoanType') ? 'selected' : ''); ?>><?php echo e($lt->LoanType); ?>
                            ...
                            <select name="Employee" id="Employee" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($emp->id); ?>"
                                        <?php echo e($emp->id == old('Employee') ? 'selected' : ''); ?>>
...
<script>
    ...
    </script><?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/deduction/loans/create.blade.php ENDPATH**/ ?>