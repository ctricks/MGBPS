...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Create Employee Status'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Create Employee Status</h3>
            <div class="card-tools"><a href="<?php echo e(route('admin.employeestatus.index')); ?>" class="btn btn-sm btn-dark">Back</a></div>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.employeestatus.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="employeestatus" required
                                value="<?php echo e(old('employeestatus')); ?>">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/employeestatus/create.blade.php ENDPATH**/ ?>