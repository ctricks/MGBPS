    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?php echo e(route('admin.subcategory.create')); ?>" class="btn btn-sm btn-info">New</a>
            </div>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('admin.subcategory.edit', encrypt($cat->id))); ?>"
                                    class="btn btn-sm btn-primary">Edit</a></td>
                            <td>
                                <form action="<?php echo e(route('admin.subcategory.destroy', encrypt($cat->id))); ?>"
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/subcategory/index.blade.php ENDPATH**/ ?>