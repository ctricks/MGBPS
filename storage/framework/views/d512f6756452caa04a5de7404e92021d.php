    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?php echo e(route('attendance.leavetype.create')); ?>" class="btn btn-sm btn-info">New</a>
            </div>
        </div>
                ...
                <tbody>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ltDet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('attendance.leavetype.edit', encrypt($ltDet->id))); ?>"
                                    class="btn btn-sm btn-primary">Edit</a></td>
                            <td>
                                <form action="<?php echo e(route('attendance.leavetype.destroy', encrypt($ltDet->id))); ?>" method="POST"
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/attendance/leavetype/index.blade.php ENDPATH**/ ?>