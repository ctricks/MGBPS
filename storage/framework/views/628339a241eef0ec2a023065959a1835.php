...
unset($__sessionArgs); ?>
        ...
        <div class="card-body">
            <form action="<?php echo e(route('attendance.holiday.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/attendance/holiday/index.blade.php ENDPATH**/ ?>