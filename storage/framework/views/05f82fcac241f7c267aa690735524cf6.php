    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?php echo e(route('admin.category.create')); ?>" class="btn btn-sm btn-info">New</a>
            </div>
        </div>
        <div class="card-body">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/category/index.blade.php ENDPATH**/ ?>