                ...
                <tbody>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($department->isActive == 1 ? "Active":"In-active"); ?></td>
                            <td><?php echo e($department->created_at); ?></td>
                            <td>
                                <a href="<?php echo e(route('admin.department.edit', encrypt($department->id))); ?>"
                                    class="btn btn-sm btn-primary">Edit</a>
                            </td>
                            <td>
                                <form action="<?php echo e(route('admin.department.destroy', encrypt($department->id))); ?>" method="POST"
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/department/index.blade.php ENDPATH**/ ?>