...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools"><a href="<?php echo e(route('admin.department.index')); ?>" class="btn btn-sm btn-dark">Back</a></div>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.department.update',$department)); ?>" method="POST">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="Department" required
                                value="<?php echo e($department->departmentname); ?>">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/department/edit.blade.php ENDPATH**/ ?>