...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title','Rest Day'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Rest Day Table</h3>
            <div class="card-tools">
                <a href="<?php echo e(route('attendance.restday.create')); ?>" class="btn btn-sm btn-info">New</a>
            </div>
        </div>
...
unset($__sessionArgs); ?>
            ...
            <form action="<?php echo e(route('attendance.restday.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empDet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($empDet->isActive == 1 ? "Active":"In-active"); ?></td>
                            <td><a href="<?php echo e(route('attendance.restday.edit', encrypt($empDet->id))); ?>"
                                    class="btn btn-sm btn-primary">Edit</a></td>
                            <td>
                                <form action="<?php echo e(route('attendance.restday.destroy', encrypt($empDet->id))); ?>" method="POST"
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/attendance/restday/index.blade.php ENDPATH**/ ?>