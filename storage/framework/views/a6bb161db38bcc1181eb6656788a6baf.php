...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Create Position'); ?>
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.position.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-6">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/admin/position/create.blade.php ENDPATH**/ ?>