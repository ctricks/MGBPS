...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Edit DTR Correction Type'); ?>
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Edit DTR Correction : <?php echo e($employeename); ?></h3>
                        <div class="card-tools">
                            <a href="<?php echo e(route('attendance.dtrcorrection.index')); ?>" class="btn btn-info btn-sm">Back</a>
                        </div>
                    </div>
                    <form class="needs-validation" novalidate action="<?php echo e(route('attendance.dtrcorrection.update', $data)); ?>"
                        method="POST">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="string" class="form-control" id="description" name="description"
                                        placeholder="Enter Description" value = "<?php echo e($data->Remarks); ?>" required >
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="StartDate" name="StartDate"
                                        placeholder="Enter Date" value = "<?php echo e($data->date); ?>" required >
...
<?php endif; ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                            ...
                                            <input 
                                                type="time"  
                                                id="time_in" name="time_in" value="<?php echo e((date('H:i', strtotime($data->IN)))); ?>">
                                                <label for="name">TimeOUT:</label>
                                            <input 
                                                type="time"  
                                                id="time_in" name="time_out" value="<?php echo e((date('H:i', strtotime($data->OUT)))); ?>">
                                </div>
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/attendance/dtrcorrection/edit.blade.php ENDPATH**/ ?>