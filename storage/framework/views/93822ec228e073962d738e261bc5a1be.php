                ...
                <div class="card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="<?php echo e(route('deductions.loans.index')); ?>" class="btn btn-info btn-sm">Back</a>
                        </div>
                    </div>
                    <form class="needs-validation" novalidate action="<?php echo e(route('deductions.loans.update', $data)); ?>"
                        method="POST">
...
<?php endif; ?>
<?php /**PATH D:\PAYROLL\PS\adminlte-laravel10\resources\views/deduction/loansdetails/edit.blade.php ENDPATH**/ ?>